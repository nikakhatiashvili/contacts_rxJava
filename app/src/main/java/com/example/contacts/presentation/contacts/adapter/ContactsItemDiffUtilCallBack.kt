...
class ContactsItemDiffUtilCallBack : DiffUtil.ItemCallback<ContactsAdapter.ListItem>() {
    override fun areItemsTheSame(oldItem: ContactsAdapter.ListItem, newItem: ContactsAdapter.ListItem): Boolean {
        return when {
    ...
    override fun areContentsTheSame(oldItem: ContactsAdapter.ListItem, newItem: ContactsAdapter.ListItem): Boolean {
